...
Pod::Spec.new do |s|
  ...
  # The current VRTX release exposes the environment case as `production`,
  # matching the Android SDK and what VrtxSdkModule.swift already passes, and
  # does not leak DeviceKit into the framework's public .swiftinterface.
  #
